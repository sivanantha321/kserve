...
# Install KEDA dependencies only
#
# AUTO-GENERATED from: keda-dependency-install.definition
# DO NOT EDIT MANUALLY
#
# To regenerate:
#   ./scripts/generate-install-script.py keda-dependency-install.definition
#
# Usage: keda-dependency-install.sh [--reinstall|--uninstall]
...
main() {
    ...
    echo "=========================================="
    echo "Install KEDA dependencies only"
    echo "=========================================="
