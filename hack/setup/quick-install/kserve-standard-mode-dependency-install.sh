...
#
# To regenerate:
#   ./scripts/generate-install-script.py kserve-standard-mode-dependency-install.definition
#
# Usage: kserve-standard-mode-dependency-install.sh [--reinstall|--uninstall]
